...
file_path = 'd:/G/GHR/Assets/Editor/SceneBuilder/Chapter1SceneBuilder.cs'
...
if start_idx != -1 and end_idx != -1:
    new_code = '''            // ==========================================
            ...
            // Stress (?n d?ng sau nang lu?ng ho?c n?m du?i, theo mockup không có thanh stress rõ, ta làm nh? ? du?i)
            ...
            stressSliderImg.color = new Color(0.8f, 0.1f, 0.1f); // Ð?
            ...
            trRect.anchoredPosition = new Vector2(-250, -50); // Lùi vào d? nhu?ng ch? cho la bàn
            ...
            moneyText.rectTransform.anchoredPosition = new Vector2(30, 0); // L?ch sang ph?i
            moneyText.rectTransform.sizeDelta = new Vector2(280, 80);
            moneyText.text = "50,000 VNÐ";
            moneyText.fontSize = 42; moneyText.alignment = TMPro.TextAlignmentOptions.Center;
            moneyText.color = new Color(0.3f, 0.2f, 0.1f); // Nâu d?m
            moneyText.fontStyle = TMPro.FontStyles.Bold;

            // 3. Top Right - Ð?ng h? La Bàn
            ...
            // 4. Bottom Center - M?t Bàn Pha Ch?
            ...
            string[] invNames = { "TRÀ:\n10", "ÐU?NG:\n10", "LY:\n20", "ÐÁ:\n100%" };
            Sprite[] invSprites = { sprTea, sprSugar, null, null }; // Ly và dá t? tô màu t?m
            ...
            pRect.anchoredPosition = new Vector2(0, 100); // Ðua lên trên xe d?y
            pRect.sizeDelta = new Vector2(150, 60);
            
            // Vi?n d? cho nút E
            promptObj.AddComponent<UnityEngine.UI.Image>().color = new Color(0, 0, 0, 0.5f); // N?n den m?
            var pOutline = promptObj.AddComponent<UnityEngine.UI.Outline>();
            pOutline.effectColor = Color.red; pOutline.effectDistance = new Vector2(2, 2);
